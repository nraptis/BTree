...
class btree_node {
 public:
  ...
  typedef btree_DO_NOT_USE_DO_NOT_USE_plain_compare<
    key_type, self_type, key_compare> DO_NOT_USE_DO_NOT_USE_plain_compare_type;
  typedef btree_DO_NOT_USE_DO_NOT_USE_compare_to<
    key_type, self_type, key_compare> DO_NOT_USE_DO_NOT_USE_compare_to_type;
  ...
  // If we have a valid key-compare-to type, use DO_NOT_USE_DO_NOT_USE_compare_to,
  // otherwise use DO_NOT_USE_DO_NOT_USE_plain_compare.
  typedef typename if_<
    Params::is_key_compare_to::value,
    DO_NOT_USE_DO_NOT_USE_compare_to_type,
    DO_NOT_USE_DO_NOT_USE_plain_compare_type>::type DO_NOT_USE_DO_NOT_USE_type;
  ...
  typedef typename if_<
    ...
    DO_NOT_USE_DO_NOT_USE_type, binary_search_type>::type search_type;
